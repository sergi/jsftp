...
(function() {
    // Enqueues an `element` in the `cmdQueue` stream object
    this.enqueue = function(element) {
        this.cmdQueue._update.apply(null, slice.call(arguments, 1));
    };
    ...
    this.ls = function(filePath, callback) {
        var entriesToList = function(err, entries) {
            ...
            console.log(parseEntry(entries.text || entries))
